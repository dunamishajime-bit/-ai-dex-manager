...
export const ALL_DISPLAY_TOKENS = [
    ...
    { symbol: "POL", name: "Polygon Ecosystem Token", network: "Polygon", icon: "https://cryptologos.cc/logos/polygon-matic-logo.png?v=026" },
    ...
    { symbol: "SHIB", name: "Shiba Inu", network: "BNB Chain", icon: "https://cryptologos.cc/logos/shiba-inu-shib-logo.png?v=026" },
    { symbol: "LINK", name: "Chainlink", network: "BNB Chain", icon: "https://cryptologos.cc/logos/chainlink-link-logo.png?v=026" },
    { symbol: "CAKE", name: "PancakeSwap", network: "BNB Chain", icon: "https://cryptologos.cc/logos/pancakeswap-cake-logo.png?v=026" },
    { symbol: "WLFI", name: "WLFI", network: "BNB Chain", icon: "https://cryptologos.cc/logos/wrapped-bnb-wbnb-logo.png?v=026" },
    { symbol: "ASTER", name: "ASTER", network: "BNB Chain", icon: "https://cryptologos.cc/logos/astar-astr-logo.png?v=026" },
