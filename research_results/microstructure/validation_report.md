# Microstructure Robustness Validation
...
- Full universe, all available features: holdout CAGR 85.19%, max DD -7.14%.
- Without PENGU: holdout CAGR -41.07%, max DD -14.09%.
- PENGU hedged spread: holdout CAGR 7856.07%, max DD -6.84%.
