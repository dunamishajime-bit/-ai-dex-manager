...
class RuntimeWiringV52CapsTest(unittest.TestCase):
    def test_v52_strict_caps_override_legacy_environment(self):
        ...
        self.assertIn("DISDEX_V52_CRYPTO_GROSS_CAP=3.0", source)
        self.assertIn("DISDEX_V52_STOCK_GROSS_CAP=4.0", source)
        self.assertIn("DISDEX_V52_PORTFOLIO_GROSS_CAP=4.25", source)
