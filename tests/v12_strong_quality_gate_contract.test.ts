...
test("integrated production risk preserves the V12 Dynamic contract Q102 HIGH_VOL 1.665x", () => {
...
test("committed one-year research artifact matches the production candidate", async () => {
  ...
  assert.equal(artifact.frozenProductionContract.q102FamilyGross.BRK, INTEGRATED_PRODUCTION_RISK_POLICY.q102FamilyGross.BRK);
