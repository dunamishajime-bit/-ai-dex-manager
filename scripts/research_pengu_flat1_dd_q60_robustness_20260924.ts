...
async function fetchArray(url:URL){
  ...
  for(let a=0;a<6;a++){
    try{
      const res=await fetch(url,{headers:{accept:"application/json","user-agent":"DisDex-PENGU-Flat1-DD-Q60-Robustness/20260924"}});
...
function routeHardstopHours(route?:EntryRoute){
  ...
  if(ddMode==="ROUTE_HARDSTOP_Q58")return 58;
  if(ddMode==="ROUTE_HARDSTOP_Q60"||ddMode.startsWith("Q60_DD"))return 60;
  if(ddMode==="ROUTE_HARDSTOP_Q62")return 62;
...
function strategyDdGovernor(){
  ...
  const q60integer=String(ddMode).match(/^Q60_DD(13|14|15|16|17)_H(48|72|96)$/);
  if(q60integer)return {threshold:-Number(q60integer[1])/100,hours:Number(q60integer[2])};
  const q60fine=String(ddMode).match(/^Q60_DD(165|170|175|180)_H(60|72|84)$/);
  if(q60fine)return {threshold:-Number(q60fine[1])/1000,hours:Number(q60fine[2])};
  return undefined;
}
...
async function main(){
  ...
  const variants:DDMode[]=[
    "BASELINE_FLAT1",
    "ROUTE_HARDSTOP_Q58","ROUTE_HARDSTOP_Q60","ROUTE_HARDSTOP_Q62",
    "Q60_DD165_H60","Q60_DD165_H72","Q60_DD165_H84",
    "Q60_DD170_H60","Q60_DD170_H72","Q60_DD170_H84",
    "Q60_DD175_H60","Q60_DD175_H72","Q60_DD175_H84",
    "Q60_DD180_H60","Q60_DD180_H72","Q60_DD180_H84"
  ];
  const result:any={
    schema:"pengu-flat1-dd-q60-robustness/v5",
    ...
    candidates:{
      ...
      ROUTE_HARDSTOP_Q58:"same-route hard-stop quarantine58h",
      ROUTE_HARDSTOP_Q62:"same-route hard-stop quarantine62h",
      Q60_DD165_H60:"Q60 + DD16.5% pause60h", Q60_DD165_H72:"Q60 + DD16.5% pause72h", Q60_DD165_H84:"Q60 + DD16.5% pause84h",
      Q60_DD170_H60:"Q60 + DD17.0% pause60h", Q60_DD170_H72:"Q60 + DD17.0% pause72h", Q60_DD170_H84:"Q60 + DD17.0% pause84h",
      Q60_DD175_H60:"Q60 + DD17.5% pause60h", Q60_DD175_H72:"Q60 + DD17.5% pause72h", Q60_DD175_H84:"Q60 + DD17.5% pause84h",
      Q60_DD180_H60:"Q60 + DD18.0% pause60h", Q60_DD180_H72:"Q60 + DD18.0% pause72h", Q60_DD180_H84:"Q60 + DD18.0% pause84h",
    },
  ...
  await fs.mkdir(".research-state/pengu-flat1-dd-q60-robustness",{recursive:true});
  await fs.writeFile(".research-state/pengu-flat1-dd-q60-robustness/result.json",JSON.stringify(result,null,2)+"\n");
  ...
  console.log("PENGU_FLAT1_DD_Q60_ROBUSTNESS="+JSON.stringify(compact));
  console.log("PENGU_FLAT1_DD_Q60_ROBUSTNESS_CONTRACT_PASS="+JSON.stringify({gross:1,logic:"COMBINED_FILTERED",variants:variants.length,baselineParity:true,researchOnly:true}));
}
