...
async function main() {
    ...
    const client = new AsterV3Client({
        ...
        userAgent: "DisDex-V46-PENGU-DualEngine/1.0",
    });
    ...
    const config = buildDefaultDisDexV46RunnerConfig({
        mode: runnerMode,
        liveExecutionEnabled: boolEnv("DISDEX_V46_LIVE_EXECUTION_ENABLED", false),
        productionConfigLiveEnabled: DISDEX_V46_RUNTIME.liveTradingEnabled,
