...
async function main(){
  ...
  await fs.mkdir(".research-state/pengu-continuation-reentry",{recursive:true});await fs.writeFile(".research-state/pengu-continuation-reentry/result.json",JSON.stringify(result,null,2)+"\n");
