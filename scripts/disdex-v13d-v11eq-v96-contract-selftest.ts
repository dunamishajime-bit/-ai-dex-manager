...
assert.equal(DISDEX_V13D_V11EQ_V96_RUNTIME.liveTradingEnabled, false);
assert.equal(DISDEX_V13D_V11EQ_V96_RUNTIME.orderSubmissionAllowed, false);
assert.throws(() => assertLiveOrderSubmissionEnabled(), /Codex must implement/);

console.log("V13D + V11-EQ + Crypto V96 implementation contract self-test: PASS");
