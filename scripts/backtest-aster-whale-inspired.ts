...
const VARIANTS: Variant[] = [
  {
    key: "whale_conviction_swing",
    title: "0x1527 conviction swing long",
    allowLong: true,
    allowShort: false,
    entryMode: "5m_close",
    useD1: true,
    ...
    stopLossPct: 0.009,
    takeProfitPct: 0.03,
    trailActivationPct: 0.018,
    trailRetracePct: 0.006,
  },
  {
    key: "whale_catalyst_readd",
    title: "0x1527 catalyst re-add long",
    allowLong: true,
    allowShort: false,
    entryMode: "5m_close",
    useD1: true,
  ...
  {
    key: "ogle_reopen_intraday",
    title: "0x70F65 reopen intraday long",
    allowLong: true,
    allowShort: false,
    entryMode: "5m_close",
    useD1: false,
    ...
    allowedHoursUtc: [11, 12, 13, 14, 15, 16, 17, 18, 19],
  },
  {
    key: "ogle_reopen_confirmed",
    title: "0x70F65 reopen confirmed long",
    allowLong: true,
    allowShort: false,
  ...
  {
    key: "accumulation_follow_through",
    title: "0x2204/0xAF37 accumulation follow-through long",
    allowLong: true,
    allowShort: false,
    entryMode: "5m_close",
    useD1: true,
  ...
  {
    key: "whale_overlay_london_burst",
    title: "Whale overlay London burst long",
    allowLong: true,
    allowShort: false,
    entryMode: "5m_close",
    useD1: true,
  ...
  {
    key: "session_burst_breakout",
    title: "Session burst breakout dual",
    allowLong: true,
    allowShort: true,
    entryMode: "1m_confirm",
    useD1: false,
  ...
  {
    key: "session_burst_pullback",
    title: "Session burst pullback continuation long",
    allowLong: true,
    allowShort: false,
    entryMode: "1m_confirm",
    useD1: false,
...
function renderMarkdown(results: Result[]) {
  return [
    "# ASTER/USDT whale-inspired backtest",
    "",
    `- symbol: ${SYMBOL}`,
    `- period: ${new Date(START_TS).toISOString()} -> ${new Date(END_TS).toISOString()}`,
    `- structure: whale-inspired ASTER ideas using higher timeframe bias, session focus, and reversal/continuation triggers`,
    "",
