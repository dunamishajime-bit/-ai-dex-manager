...
printf '%s\n' "{\"productionCommitSha\":\"$old_sha\",\"kind\":\"parity\"}" > "$parity"
printf '%s\n' "{\"approvedCommitSha\":\"$old_sha\",\"kind\":\"override\"}" > "$override"
printf '%s\n' "{\"approvedCommitSha\":\"$old_sha\",\"kind\":\"crypto\"}" > "$crypto"
printf '%s\n' "{\"approvedCommitSha\":\"$old_sha\",\"kind\":\"stock\"}" > "$stock"
...
printf '%s\n' "{\"productionCommitSha\":\"$new_sha\",\"kind\":\"parity\"}" > "$parity"
printf '%s\n' "{\"approvedCommitSha\":\"$new_sha\",\"kind\":\"override\"}" > "$override"
printf '%s\n' "{\"approvedCommitSha\":\"$new_sha\",\"kind\":\"crypto\"}" > "$crypto"
printf '%s\n' "{\"approvedCommitSha\":\"$new_sha\",\"kind\":\"stock\"}" > "$stock"
