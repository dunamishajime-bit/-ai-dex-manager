...
disdex_apply_v96_v52_fixed_live_policy() {
  ...
  export DISDEX_V52_V11_GROSS_CAP=1.5
  export DISDEX_V52_V50_GROSS_CAP=1.25
  export DISDEX_V52_RESERVED_FIRST_STOCK_GROSS=1.25
...
disdex_assert_v96_v52_fixed_live_policy() {
  ...
  [[ "${DISDEX_V52_RESERVED_FIRST_STOCK_GROSS:-}" == "1.25" ]] || return 1
  [[ "${DISDEX_V52_V11_GROSS_CAP:-}" == "1.5" ]] || return 1
  [[ "${DISDEX_V52_V50_GROSS_CAP:-}" == "1.25" ]] || return 1
