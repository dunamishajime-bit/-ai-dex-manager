...
ROLLING = [(f"ROLLING_{y:04d}-{m:02d}", jst08(y, m, 1), jst08(y + 1 if m == 10 else y, 1 if m == 10 else m + 3, 1)) for y, m in ((2023, 7), (2023, 10), (2024, 1), (2024, 4), (2024, 7), (2025, 7))]
...
def main() -> None:
    ...
    full_start, full_end = jst08(2023, 7, 1), jst08(2026, 7, 1)
    candidates = _records_for_window(candles, index, models, full_start, full_end, 10.0, 0)
    stress_candidates = _records_for_window(candles, index, models, full_start, full_end, 30.0, 1)
    runs: dict[str, Any] = {}
