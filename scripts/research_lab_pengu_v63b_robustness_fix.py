...
def main() -> None:
    ...
    (state_dir / "pengu-v63b-robustness.json").write_text(json.dumps(payload, ensure_ascii=False, indent=2), encoding="utf-8")
    report = [
    ...
    (state_dir / "pengu-v63b-robustness.md").write_text("\n".join(report), encoding="utf-8")
    print("\n".join(report))
