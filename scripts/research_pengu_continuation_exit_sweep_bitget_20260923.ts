...
async function main(){
  ...
  const outDir=".research-state/pengu-continuation-exit-bitget";await fs.mkdir(outDir,{recursive:true});await fs.writeFile(path.join(outDir,"result.json"),JSON.stringify(out,null,2)+"\n");
