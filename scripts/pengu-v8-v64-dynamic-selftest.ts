...
// The raw V64 request may exceed the fixed 1.0 sleeve cap; strict planning clamps it.
assert.equal(penguV8V64RequestedLongGross({ ...f, atr24Ratio: 0.01, penguReturn72h: 0.10 }), 1.25);
