...
assert.equal(decideV12ResidualEntry(1, { ...empty, v12Gross: 1, cryptoGross: 1.75, totalGross: 1.75 }, 1).acceptedGross, 0.5);
assert.equal(decideV12ResidualEntry(1, { ...empty, v12Gross: 1, cryptoGross: 1, stockGross: 1.4, totalGross: 2.4 }, 1).acceptedGross, 0.5);
