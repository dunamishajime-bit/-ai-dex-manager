...
This script is intentionally idempotent. It patches existing large files inside
GitHub Actions so the repository contents API does not need to replace a
10k-line React context manually.
"""
