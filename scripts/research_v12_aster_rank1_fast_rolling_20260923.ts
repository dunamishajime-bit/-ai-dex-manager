...
const H = 3_600_000;
const START = Date.parse(process.env.V12_START || "2025-08-10T00:00:00Z");
const END = Date.parse(process.env.V12_END || "2026-08-10T00:00:00Z");
