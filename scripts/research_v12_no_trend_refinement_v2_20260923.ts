...
const variants:Variant[]=[
  ...
  {name:"NT2_ER065_REV",...LOCKED,noTrend:{er12Max:.065,requireBtc12Adverse:true,requireBtc6OrSymbolWeak:true,symbol6Max:0}},
  {name:"NT2_ER080_REV",...LOCKED,noTrend:{er12Max:.080,requireBtc12Adverse:true,requireBtc6OrSymbolWeak:true,symbol6Max:0}},
  {name:"NT2_ER100_REV",...LOCKED,noTrend:{er12Max:.100,requireBtc12Adverse:true,requireBtc6OrSymbolWeak:true,symbol6Max:0}},
  {name:"NT2_ER120_REV",...LOCKED,noTrend:{er12Max:.120,requireBtc12Adverse:true,requireBtc6OrSymbolWeak:true,symbol6Max:0}},
  {name:"NT2_ER080_E40_REV",...LOCKED,noTrend:{er12Max:.080,er24Max:.40,requireBtc12Adverse:true,requireBtc6OrSymbolWeak:true,symbol6Max:0}},
  {name:"NT2_ER100_E40_REV",...LOCKED,noTrend:{er12Max:.100,er24Max:.40,requireBtc12Adverse:true,requireBtc6OrSymbolWeak:true,symbol6Max:0}},
  {name:"NT2_ER065_REV_ANY",...LOCKED,noTrend:{er12Max:.065,requireBtc12Adverse:true,requireBtc6OrSymbolWeak:true,symbol6Max:0,combineAnyWeak:true}},
  {name:"NT2_ER080_REV_ANY",...LOCKED,noTrend:{er12Max:.080,requireBtc12Adverse:true,requireBtc6OrSymbolWeak:true,symbol6Max:0,combineAnyWeak:true}},
  {name:"NT2_ER100_REV_ANY",...LOCKED,noTrend:{er12Max:.100,requireBtc12Adverse:true,requireBtc6OrSymbolWeak:true,symbol6Max:0,combineAnyWeak:true}},
  {name:"NT2_ER080_E40_REV_ANY",...LOCKED,noTrend:{er12Max:.080,er24Max:.40,requireBtc12Adverse:true,requireBtc6OrSymbolWeak:true,symbol6Max:0,combineAnyWeak:true}},
];
const modes: Mode[] = [
...
function noTrendMatch(s:RoutedSignal,opt:NonNullable<Variant["noTrend"]>){
  const f=s.features;
  const erOk=f.btcEr12<opt.er12Max && (opt.er24Max==null || f.btcEr24<opt.er24Max);
...
async function main(){
  ...
  const today=[
    {name:"XRP04",btc6h:.0066831078,btc12h:.0135392327,btc24h:.0079083608,btcEr12:.6495841762,btcEr24:.1755519934,ret6h:.0220530835,volumeRatio:1.2807997616,rel24h:.0429243594},
    {name:"INJ0840",btc6h:-.0024962400,btc12h:-.0008547108,btc24h:-.0045845749,btcEr12:.0600798891,btcEr24:.1113855828,ret6h:.0095904614,volumeRatio:.6805999871,rel24h:.0105246575},
    {name:"XRP0840",btc6h:-.0024962400,btc12h:-.0008547108,btc24h:-.0045845749,btcEr12:.0600798891,btcEr24:.1113855828,ret6h:-.0022906592,volumeRatio:.6626521062,rel24h:.0165239102},
    {name:"LTC13",btc6h:.0058963975,btc12h:.0033854387,btc24h:.0115899026,btcEr12:.2751223184,btcEr24:.3351334931,ret6h:.0155001598,volumeRatio:.9565703326,rel24h:.0291896585},
    {name:"SOL15",btc6h:.0033678591,btc12h:-.0009221436,btc24h:.0126046040,btcEr12:.0725586470,btcEr24:.3737584219,ret6h:-.0011815343,volumeRatio:.7124622159,rel24h:.0007527039},
    {name:"NEAR17",btc6h:-.0024722423,btc12h:-.0005490277,btc24h:.0090268086,btcEr12:.0443174365,btcEr24:.2418296550,ret6h:.0166243362,volumeRatio:.7927949439,rel24h:-.0005522323}
  ];
  const todayAudit=variants.map(v=>{
    if(!v.noTrend)return {variant:v.name,blocked:[]};
    const blocked=today.filter(f=>{
      const erOk=f.btcEr12<v.noTrend!.er12Max&&(v.noTrend!.er24Max==null||f.btcEr24<v.noTrend!.er24Max);
