...
const REPORT_DIR = path.join(process.cwd(), "reports", "current-profile-latest-window");
const WINDOW_START = Date.UTC(2025, 11, 31, 0, 0, 0, 0);
...
async function main() {
  ...
  const options = {
    ...
    label: "current_profile_latest_window",
  } as const;
