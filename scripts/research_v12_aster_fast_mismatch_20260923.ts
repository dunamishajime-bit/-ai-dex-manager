...
type Variant = {
  ...
  noTrend?: {er12Max:number; er24Max?:number; requireBtc12Adverse?:boolean; requireBtc6OrSymbolWeak?:boolean; requireSymbol6Weak?:boolean; symbol6Max?:number; includeBurst?:boolean; burstEr12Max?:number; combineAnyWeak?:boolean; minScore?:number};
};
...
const variants:Variant[]=[
  ...
  {name:"FB80_FAST_E065_S010_Q040",...LOCKED,noTrend:{er12Max:.065,requireBtc12Adverse:true,requireSymbol6Weak:true,symbol6Max:.010,minScore:.40,includeBurst:true,burstEr12Max:.80}},
  {name:"FB80_FAST_E065_S0125_Q040",...LOCKED,noTrend:{er12Max:.065,requireBtc12Adverse:true,requireSymbol6Weak:true,symbol6Max:.0125,minScore:.40,includeBurst:true,burstEr12Max:.80}},
  {name:"FB80_FAST_E065_S015_Q040",...LOCKED,noTrend:{er12Max:.065,requireBtc12Adverse:true,requireSymbol6Weak:true,symbol6Max:.015,minScore:.40,includeBurst:true,burstEr12Max:.80}},
  {name:"FB80_FAST_E070_S010_Q040",...LOCKED,noTrend:{er12Max:.070,requireBtc12Adverse:true,requireSymbol6Weak:true,symbol6Max:.010,minScore:.40,includeBurst:true,burstEr12Max:.80}},
  {name:"FB80_FAST_E070_S0125_Q040",...LOCKED,noTrend:{er12Max:.070,requireBtc12Adverse:true,requireSymbol6Weak:true,symbol6Max:.0125,minScore:.40,includeBurst:true,burstEr12Max:.80}},
  {name:"FB80_FAST_E070_S015_Q040",...LOCKED,noTrend:{er12Max:.070,requireBtc12Adverse:true,requireSymbol6Weak:true,symbol6Max:.015,minScore:.40,includeBurst:true,burstEr12Max:.80}},
  {name:"FB80_FAST_E080_S0125_Q040",...LOCKED,noTrend:{er12Max:.080,requireBtc12Adverse:true,requireSymbol6Weak:true,symbol6Max:.0125,minScore:.40,includeBurst:true,burstEr12Max:.80}},
  {name:"FB80_FAST_E080_S015_Q040",...LOCKED,noTrend:{er12Max:.080,requireBtc12Adverse:true,requireSymbol6Weak:true,symbol6Max:.015,minScore:.40,includeBurst:true,burstEr12Max:.80}},
  {name:"FB80_FAST_E090_S015_Q040",...LOCKED,noTrend:{er12Max:.090,requireBtc12Adverse:true,requireSymbol6Weak:true,symbol6Max:.015,minScore:.40,includeBurst:true,burstEr12Max:.80}},
  {name:"FB80_FAST_E070_S015_Q035",...LOCKED,noTrend:{er12Max:.070,requireBtc12Adverse:true,requireSymbol6Weak:true,symbol6Max:.015,minScore:.35,includeBurst:true,burstEr12Max:.80}},
];
const modes: Mode[] = [
...
function noTrendMatch(s:RoutedSignal,opt:NonNullable<Variant["noTrend"]>){
  ...
  const symbolWeakOk=!opt.requireSymbol6Weak || f.ret6h<(opt.symbol6Max??.005);
  const noTrend=erOk&&btc12Ok&&weakOk&&symbolWeakOk;
