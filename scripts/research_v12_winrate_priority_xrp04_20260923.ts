...
const variants:Variant[]=[
  ...
  {name:"FALSEBURST70_ONLY",...LOCKED,noTrend:{er12Max:0,includeBurst:true,burstEr12Max:.70}},
  {name:"FALSEBURST75_ONLY",...LOCKED,noTrend:{er12Max:0,includeBurst:true,burstEr12Max:.75}},
  {name:"FALSEBURST80_ONLY",...LOCKED,noTrend:{er12Max:0,includeBurst:true,burstEr12Max:.80}},
  {name:"ANY_FALSEBURST70",...LOCKED,noTrend:{er12Max:0,includeBurst:true,burstEr12Max:.70,combineAnyWeak:true}},
  {name:"ANY_FALSEBURST75",...LOCKED,noTrend:{er12Max:0,includeBurst:true,burstEr12Max:.75,combineAnyWeak:true}},
  {name:"ANY_FALSEBURST80",...LOCKED,noTrend:{er12Max:0,includeBurst:true,burstEr12Max:.80,combineAnyWeak:true}},
];
const modes: Mode[] = [
