...
## Follow-up 2026-09-26: requested V12 0.55 / 0.85, Q102, lock stress and disk
- V12 public Aster 14-symbol 248 common H2 bars / 170 decision windows, original selector parity exact, 0.3% roundtrip cost and 24h overlapping forward-return proxy (NOT formal integrated BT):
  - frozen 0.9845 / 1.4649: 114 potential entries, +1.457927% average signed 24h net forward proxy, 57.0175% positive;
  - requested volume0.55 / score0.85: 156 potential entries, +1.103938% average, 55.7692% positive;
  - newly admitted candidate keys105, frozen candidate keys displaced63; newly admitted only +1.310533% average, 60% positive;
  - volume0.80 only: 123 potential entries, +1.749628% average; volume0.80 / score1.00: 133 entries, +1.539053% average.
  - HC 1.75 multiplier unchanged. Do NOT substitute any forward proxy for resident-stop realized account return, PF, DD or portfolio compound outcome. Source https://github.com/dunamishajime-bit/-ai-dex-manager/actions/runs/36236991364
- September Q102 frozen monthly HIGH_VOL source from actual runtime market-history and ranking, of 22 source symbols only 3 had usable causal-comparable history: FROZEN 7 raw candidate hours, 2 isolated trades, both losses, NORMAL -11.27534%, SEVERE -11.53899%; ret threshold 0.90x gives 9 raw hours and still 2 isolated trades, NORMAL -11.27287%; ret0.80x+RSI+5 gives17 raw hours and still 2 trades, NORMAL -11.27781%. Severe max DD likewise about 11.53–11.55%; not statistically representative and excludes S34 priority, PENGU and integrated gross. https://github.com/dunamishajime-bit/-ai-dex-manager/actions/runs/36237129415
- Six process Node/Python isolated rate-budget stress: 100 Node+50 Python slots, orphaned locks0. Five-process account lock:125 reservation cycles, simultaneous owners0, orphaned locks0, real orders0. https://github.com/dunamishajime-bit/-ai-dex-manager/actions/runs/36236993667
- On VPS, exact installed e1b580... production libraries: three deploy Node+two root Python workers, 125 isolated shared-budget reservations, none failed, orphaned locks0, mode0660 and deploy group; no Aster orders. Live budget file naturally changes as actual services run, so bytewise live-budget equality is NOT a valid no-mutation oracle. https://github.com/dunamishajime-bit/-ai-dex-manager/actions/runs/36237130990
- Disk current root free 4.242 GB before lossless temp archival compression; after 4.419 GB (+176.91 MB). Original aged UI tar backups and completed research text outputs replaced with gzip, SHA-256 decompression verified, active five runner PIDs unchanged. No live data, original BT datasets, releases, open nginx logs or state JSON modified. https://github.com/dunamishajime-bit/-ai-dex-manager/actions/runs/36237529991
- Official installed source-matching protected retention revalidated: zero safe release/UI candidates, 57 unverified protected old paths, current and rollback unaffected; empty subsequent binding archives cannot be taken as positive archival proof. https://github.com/dunamishajime-bit/-ai-dex-manager/actions/runs/36237376064
- Archival-reference plan identified 24 releases over 7 days old referenced only from 89 archival backup files, but these references are **not sufficient authority to delete their actual original release directories**. Archive/certify source and rollback/executable dependencies before any removal; never destroy historical BT source. https://github.com/dunamishajime-bit/-ai-dex-manager/actions/runs/36237256299
- Test coverage proves the specified concurrent interleavings and cross-UID write behavior; no finite stress test proves that no future Aster HTTP 429, crashed worker, filesystem fault or lock race can ever occur. Keep fail-closed controls and monitor.
