...
type LocalDiscussionProposal = {
    result: {
        autoTradeProposal: AutoTradeProposal;
    };
};

interface AutoTradeSimulatorProps {
    marketData: CoinDetails | null;
    proposal: LocalDiscussionProposal["result"]["autoTradeProposal"];
    onClose: () => void;
}

const formatTooltipPrice: Formatter<ValueType, NameType> = (value) => {
