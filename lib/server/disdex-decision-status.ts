  ...
  return {
    ...
    units: [
      ...
      },
      {
        ...
        entryPolicy: "通常Long/Shortを優先し、通常Signal不成立時だけRecovery V8を評価。通常上限0.75x / Recovery上限0.50x、保有中の追加・反転なし",
        protection: "Short V20 + Recovery V8。Recoveryは-4% delayed partial、-6% hard stop、hard-stop後24h cooldown、+6% trailing開始 / 3% retrace、最大72h。Crypto Gross上限2.00x / Total Gross上限2.50x",
        note: "最新のVPS stateを確認できた場合だけLIVE表示します。",
      ...
      },
      {
        ...
        entryPolicy: "固定snapshotのV50候補をRank1通常=1.00x（basis≥75/net≥10）、強=1.25x（100/15）、Rank2=0.25x（85/10）で最大2建玉。各20秒窓（11:30/12:30/13:30 NY）",
        protection: "V50 max hold3h・basis stop1.75x・adverse10bps、V11 tiers 0.75/1.00/1.25/1.50、日次損失・建玉照合・共有Kill Switch。Stock1.50x / Crypto2.00x / Global2.50x",
