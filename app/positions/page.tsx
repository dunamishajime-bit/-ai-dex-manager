    ...
    <main className="relative min-h-full overflow-hidden rounded-[28px] border border-gold-400/16 bg-[#04060a] p-3 text-white md:p-4">
      <div className="relative z-10 space-y-3">
        <header className="panel-gold rounded-[30px] p-5 md:p-7">
          ...
          <h1 className="gold-heading mt-3 text-3xl font-black tracking-tight md:text-5xl">{productionRuntime && v12 && pengu && v52 ? `${v12.strategyId} / ${pengu.strategyId} / Q102 ${q102?.selectorMode ?? "UNAVAILABLE"} / FET BRK48 / ${v52.policyId}` : "DISTerminal Production Runtime"}</h1>
